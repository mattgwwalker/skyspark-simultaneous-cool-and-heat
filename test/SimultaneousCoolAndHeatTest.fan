...
**
** SimultaneousCoolAndHeatTest
**
class SimultaneousCoolAndHeatTest : ProjTest
{
  ...
  Void testSparkWhenHeatingAndCoolingOnBasicModel()
  {
    ...
    addExtRec(simultaneousCoolAndHeatExt::SimultaneousCoolAndHeatExt#) // Needed for 'simultaneousCoolAndHeat'
    addExtRec(hisKitExt::HisKitExt#) 
    
    context := makeSuContext()
    fn := context.evalToFunc("simultaneousCoolAndHeat")
